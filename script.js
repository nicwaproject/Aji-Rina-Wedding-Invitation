document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('coupleNames').textContent = coupleNames || 'Aji & Rina'; // Default names
...
function calculateCountdown() {
    const weddingDate = new Date('2024-09-01T09:00:00'); // Set your wedding date and time here (e.g., 3:00 PM)
...
// messages handler
    ...
    if (messageForm) {
        messageForm.addEventListener('submit', function(e) {
            ...
            fetch('https://aji-rina.glitch.me/messages', {
                method: 'POST',
                headers: {
